using LucastecnologiaServices.Modules.Inventory.Areas.Inventory.ViewModels;
using LucastecnologiaServices.Modules.Inventory.Models;
using LucastecnologiaServices.Modules.Inventory.Services;
using System;
...
namespace LucastecnologiaServices.Modules.Inventory.Areas.Inventory.Controllers
{
    [Area("Inventory")]
