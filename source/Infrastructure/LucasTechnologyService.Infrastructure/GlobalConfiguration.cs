using LucasTechnologyService.Infrastructure.Localization;
using LucasTechnologyService.Infrastructure.Modules;
using System;
...
namespace LucasTechnologyService.Infrastructure
{
